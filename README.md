...
- Querying and filtering dinosaur taxonomic info (`Order`, `Suborder`, `Infraorder`, etc.)
- Serving API endpoints for future data pipelines, AI integration, or front-end consumption
